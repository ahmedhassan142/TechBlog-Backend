...
const logincontroller = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield usermodel_js_1.User.findOne({ email: req.body.email }).select('+password');
        if (!user) {
        ...
        if (!validPassword) {
            ...
            const directCompare = yield bcrypt_1.default.compare(req.body.password, user.password);
